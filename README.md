...
> WARNING: This version is being treated differently compared to the stable releases. Do not expect frequent updates.
...
**Also do note that the BTA port will be treated differently compared to the stable releases.**
...
**The BTA port is based upon `v1.1.0+1.18.2`, with some of the modern features and bug fixes backported for convenience.**
